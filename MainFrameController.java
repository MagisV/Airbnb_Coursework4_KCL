...
public class MainFrameController implements Initializable {
    ...
    private MainframeContentPanel[] contentPanels; // An array holding all panels to be displayed inside the mainframe.
    ...
    private void initializeFiltersComboBox() {
        ...
        filtersComboBox.addEventHandler(ComboBox.ON_HIDDEN, this::activatedFilters); // Initiate updating the filters when to box is closed
    }
