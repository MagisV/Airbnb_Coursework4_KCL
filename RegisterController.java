...
public class RegisterController {
    ...
    public void validateOfflineRegister() {
        ...
        for (Account account : accounts) {
            if (account.getUsername().equals(nameField.getText())) {
                found = true;
            }
        }
        if (found) {
    ...
    /**
     * Changes the color and text of the feedback label based on the result of a register attempt.
     */
     ...
     * @param mainFrameController   the instantiated MainFrameController object running in the background
     */
