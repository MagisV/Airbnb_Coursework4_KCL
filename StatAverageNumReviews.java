...
public class StatAverageNumReviews extends StatisticAsText {
    ...
    {
        long average = Math.round(listings.stream().mapToInt(AirbnbListing::getNumberOfReviews).average().orElse(Double.NEGATIVE_INFINITY)); // Calculate the rounded average. If the given list is empty, the result is negative infinity
