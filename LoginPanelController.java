...
public class LoginPanelController implements Initializable {
    ...
    public void goBack() {
        try {
            ...
            Alerts.errorAlerts("Error", "mainWindowController is null", "Please try again");
        }
    }
    ...
    public void validateLogin() {
        if(MainFrameController.isUsingDatabase()) {
            ...
            for (Account account : accounts) {
                try {
                    if (account.getUsername().equals(usernameTextField.getText()) && account.getPassword().equals(hashPW(passwordTextField.getText()))) {
                        user = account;
                        found = true;
                    }
                } catch (Exception e) {
