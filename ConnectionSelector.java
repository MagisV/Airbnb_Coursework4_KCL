...
public class ConnectionSelector extends Application {
     ...
     * @param stage The stage of the connection selector
     * @throws Exception When the fxml file cant be loaded.
     */
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader panelLoader = new FXMLLoader(getClass().getResource("connectionSelectorView.fxml"));
        Parent root = panelLoader.load();
